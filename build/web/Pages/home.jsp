...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <c:forEach items= "${futsals}" var="futsal">
                <div class="block">
                    <img src="image/${futsal.photo}" alt="">
                    <h1 class="title">${futsal.name}</h1>
                    <h2 class="location">${futsal.address}</h2>
                    <h2 class="read" ><a href="UserServlet?page=book&f_id=${futsal.f_id}" style="color: green; text-decoration: none;" > Book Now</a></h2>
        ...
        <div class="box-1">
            <form action="#" method="post">
                ...
                <input type="text" id="text" name="text" placeholder="search venue" required>
