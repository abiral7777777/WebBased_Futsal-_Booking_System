...
<div style="padding:180px;margin-top:0px;background-color:E9FFE8;height:1500px;">
    <div class="login-form">
        <h2>Admin Login</h2>
        <form action="${pageContext.request.contextPath}/AdminServlet?page=login" method="post">
          <label for="adminname">Adminname:</label>
          <input type="text" id="adminname" name="username" placeholder="Enter admin name" required>
